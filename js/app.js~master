...
$(document).ready(function() {
    $("#bstoad").click( function() { 

  np_date = $('#nepdate :selected').index();
  np_month = $('#nepmonth :selected').index();
  np_year = $('#nepyear :selected').val();

  console.log(np_year + ' ' + (np_month-1) + ' ' + (np_date-1)); });
});
